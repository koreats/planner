          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                활성: {statistics.activeGoals} | 완료: {statistics.completedGoals}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {formatProgress(statistics.overallProgress)}
              </div>
              <GoalProgressBar 
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {statistics.totalGoals > 0 
                  ? Math.round((statistics.completedGoals / statistics.totalGoals) * 100)
                  : 0}%
              </div>
              <div className="flex items-center gap-1 text-xs text-muted-foreground">
                <TrendingUp className="h-3 w-3" />
                <span>{statistics.completedGoals} / {statistics.totalGoals} 목표 달성</span>
              </div>
            </CardContent>
          </Card>
        </div>
