...
export function useCreateGoal() {
  ...
  return useMutation({
    mutationFn: (input: CreateGoalInput) => {
      console.log('[useCreateGoal] Creating goal with input:', input);
      return goalService.createGoal(input);
    },
    onSuccess: (data) => {
      console.log('[useCreateGoal] Goal created successfully:', data);
    ...
    onError: (error: any) => {
      console.error('[useCreateGoal] Full error object:', error);
      console.error('[useCreateGoal] Error stack:', error?.stack);
...
export function useUpdateGoal() {
  ...
  return useMutation({
    mutationFn: (input: UpdateGoalInput) => {
      console.log('[useUpdateGoal] Updating goal:', input);
    ...
    onSuccess: (data) => {
      console.log('[useUpdateGoal] Goal updated successfully:', data);
      smartInvalidate(queryClient, 'goal', data.id);
      toast({
        title: '목표 수정 완료',
...
export function useDeleteGoal() {
  ...
  return useMutation({
    mutationFn: (id: string) => {
      console.log('[useDeleteGoal] Deleting goal:', id);
      return goalService.deleteGoal(id);
    },
    onSuccess: (_, id) => {
      console.log('[useDeleteGoal] Goal deleted successfully:', id);
    ...
    onError: (error: any) => {
      console.error('[useDeleteGoal] Error:', error);
